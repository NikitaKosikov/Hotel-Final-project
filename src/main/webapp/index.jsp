...
<fmt:message bundle="${Loc}" key="Locale.button.block.room" var="delete_room_button"/>
...
<div style="display: none">
    <fmt:message bundle="${Loc}" key="${param.changed_room}" var="changed_room"/>
    <fmt:message bundle="${Loc}" key="${param.deleted_room}" var="deleted_room"/>
    <fmt:message bundle="${Loc}" key="${param.deleted_room_error}" var="deleted_room_error"/>
    <fmt:message bundle="${Loc}" key="${param.change_room_error}" var="change_room_error"/>
...
<div class="index">
        ...
        <div class="outline" style="padding-bottom: 10px">
            <div class="search">
                <div>
                    ...
                    <span class="error_place" style="color:red; top:156px; left: 330px; font-size: 15px">
                    ...
                    <span class="error_place" style="color:red; top:156px; left: 900px;font-size: 15px">
                ...
                <div style="margin-top: 20px" class="center">
                    ...
                    <div style="color: red;top:205px; left: 330px; font-size: 15px" class="error_place">
    ...
    <div style="color: red; top:240px; font-size: 20px" class="error_place"><c:out value="${access_room}"/></div>
    ...
    <div class="slider" style="font-size: 16px">
        ...
        <c:choose>
            ...
            <c:when test="${rooms.size() != 0 && rooms!=null}">
                    ...
                    <c:if test="${count<rooms.size()}">
                        ...
                        <div class="item">
                            ...
                            <c:forEach begin="0" end="2" step="1">
                                <c:if test="${count<rooms.size()}">
                                    <div class="img_room">
                                        <form id="reservation${count}" action="/Controller?command=reservationroom"
                                              method="post">
                                        ...
                                        <div>
                                                        ...
                                                        <c:if test="${sessionScope.user.roleId == 2}">
                                                            <div>
                                                                <form style="margin-bottom: 5px;"
                                                                      action="/Controller?command=blockroom"
                                                                      method="post">
                                                                    <input type="hidden" name="room_id"
                                                                           value="${rooms[status.begin+count].roomId}">
                                                                    <input type="submit" value="${delete_room_button}">
                                                                </form>
                                                            </div>
                                                        </c:if>
                                                    </div>
                                            ...
                                            <a href="#popup${count}" class="nav-link a_not_decoration">
                                                    ${reservation_button}
                                                <input style="font-size: 20px" type="hidden" name="room_id"
                                                       form="reservation${count}"
                                                       value="${rooms[status.begin+count].roomId}">
                ...
                <div style="padding: 15px" class="input_wrapper" align="center">
...
<c:forEach items="${rooms}" varStatus="status">
    <div id="popup${count_popup}" class="popup">
        ...
        <div class="popup_body">
            <div class="popup_content">
                ...
                <div class="popup_text">
                    ...
                    <c:if test="${count_popup<rooms.size()}">
                        <div style="padding-bottom: 45px">
                            <div class="login_text leftstr">
                                    ${check_in_name}
                            </div>
                            <div class="login_text rightstr">
                                <input maxlength="10" type="text" class="date_color" name="arrival_date"
                                       form="reservation${count_popup}">
                            </div>
                        </div>
                        <div style="padding-bottom: 45px">
                            <div class="login_text leftstr">
                            ...
                            <div class="login_text rightstr">
                                <input maxlength="10" type="text" class="date_color" name="departure_date"
                                       form="reservation${count_popup}">
                            </div>
                        </div>
                        ...
                        <div class="password_edit">
                            <div align="center" style="margin-top: 45px">
                                <input type="submit" class="data_edit input_hover submit" value="${reservation_name}"
                                       form="reservation${count_popup}">
                            </div>
                        </div>
                    </c:if>
