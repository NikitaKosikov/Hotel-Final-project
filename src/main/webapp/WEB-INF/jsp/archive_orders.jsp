...
<div class="container">
    ...
    <div class="index" style="height: 460px">
        ...
        <div class="hr_status">
            ...
            <a href="#" class="nav-link a_not_decoration status_order colour_order">${archive_orders_link}</a>
            <a href="/Controller?command=gotoreturnedorderspage&status=отменен" class="nav-link a_not_decoration"
                                            ...
                                            <div>
                                                <div style="margin-left: 40px; margin-right: 50px">
                                                    ...
                                                    <div style="padding: 5px" class="hr_order">
                                                        <a href="#popup${count}"
                                                           class="language_colour a_not_decoration">${room_information_link}</a>
                                                    </div>
                                                    <div style="padding: 5px">
