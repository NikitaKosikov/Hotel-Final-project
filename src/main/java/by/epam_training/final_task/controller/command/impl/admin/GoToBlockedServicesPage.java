...
public class GoToBlockedServicesPage implements Command {
    ...
    private static final String FORWARD_TO_BLOCKED_ROOMS_PAGE = "/WEB-INF/jsp/blocked_services.jsp";
    ...
    private static final String SERVICES = "additional_services";
    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        logger.info("Admin wants to view the blocked services");

        ServiceProvider serviceProvider = ServiceProvider.getInstance();
        AdditionalServiceService additionalService = serviceProvider.getAdditionalService();
        try {
            List<AdditionalService> additionalServices = additionalService.findServicesByStatus(ROOM_STATUS_IS_BLOCKED);
            request.setAttribute(SERVICES, additionalServices);
