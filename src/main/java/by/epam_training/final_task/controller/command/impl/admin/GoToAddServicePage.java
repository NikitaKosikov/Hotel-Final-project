...
public class GoToAddServicePage implements Command {
    ...
    private static final String FORWARD_TO_ADD_ROOM_PAGE = "/WEB-INF/jsp/add_service.jsp";
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher(FORWARD_TO_ADD_ROOM_PAGE);
