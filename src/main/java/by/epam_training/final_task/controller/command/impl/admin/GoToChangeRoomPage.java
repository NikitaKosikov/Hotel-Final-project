...
public class GoToChangeRoomPage implements Command {
    ...
    private static final String FORWARD_TO_CHANGE_ROOM_PAGE = "/WEB-INF/jsp/change_room.jsp";
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = request.getRequestDispatcher(FORWARD_TO_CHANGE_ROOM_PAGE);
